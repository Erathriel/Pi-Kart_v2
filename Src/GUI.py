...
class mainUI(Frame):
    ...
    def start(self):
        ...
        self.master.configure(width=1100, height=1000, bg="white")
        ...
        self.choixf2 = Radiobutton(self.master, text=" Triangulaire ", variable=self.v2, value=" triangulaire ", bg="white")
